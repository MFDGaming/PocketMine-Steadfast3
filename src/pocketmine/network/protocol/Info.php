...
interface Info{
	...
	const PROTOCOL_408 = 408; // 1.16.61
	...
	const PROTOCOL_419 = 419; // 1.16.101
	const PROTOCOL_420 = 420; // 1.16.200.51
	const PROTOCOL_421 = 421; // 1.16.200.52
	const PROTOCOL_422 = 422; // 1.16.200.57
	const PROTOCOL_423 = 423; // 1.16.210.50
	const PROTOCOL_428 = 428; // 1.16.210
